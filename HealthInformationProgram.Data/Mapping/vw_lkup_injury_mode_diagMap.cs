...
{
    public class vw_lkup_injury_mode_diagMap : EntityTypeConfiguration<vw_lkup_injury_mode_diag>
    {
        public vw_lkup_injury_mode_diagMap()
        {
            // Primary Key
            ...
            this.ToTable("vw_lkup_injury_mode_diag");
