...
{
    public class vw_lkup_all_splmtl_diagMap : EntityTypeConfiguration<vw_lkup_all_splmtl_diag>
    {
        public vw_lkup_all_splmtl_diagMap()
        {
            // Primary Key
            this.HasKey(t => new { t.diag_id, t.splmtl_diag_descn });
            ...
            this.ToTable("vw_lkup_all_splmtl_diag");
